...
import { Sort, WeaponFilter } from '../../../../models/graphql/schema.ts'

export class WeaponFilterStore {
  ...
  public getFilter(): WeaponFilter | null {
...
const weaponFilterStore = new WeaponFilterStore()
export default weaponFilterStore
