...
import { ArmyFilter, Sort } from '../../../../models/graphql/schema.ts'

export class ArmyFilterStore {
  ...
  public getFilter(): ArmyFilter | null {
...
const armyFilterStore = new ArmyFilterStore()
export default armyFilterStore
