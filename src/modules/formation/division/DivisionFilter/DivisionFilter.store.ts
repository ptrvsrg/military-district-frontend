...
import { DivisionFilter, Sort } from '../../../../models/graphql/schema.ts'

export class DivisionFilterStore {
  ...
  public getFilter(): DivisionFilter | null {
...
const divisionFilterStore = new DivisionFilterStore()
export default divisionFilterStore
