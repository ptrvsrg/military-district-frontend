...
export const BasicInfoForm = observer((props: BasicInfoFormProps) => {
  ...
  // Handlers
  const handleNameChange = (event: ChangeEvent<HTMLInputElement>) => props.divisionFormStore.setName(event.target.value)
  const handleCommanderChange = (_event: SyntheticEvent, value: MilitaryBrief | null) => props.divisionFormStore.setCommander(value ?? undefined)
      ...
      <RowWrapper>
        <ColumnWrapper>
          <TextField
            ...
            sx={{ width: '100%' }}
            value={props.divisionFormStore.getName()}
            variant={'outlined'}
          />
        </ColumnWrapper>
        <ColumnWrapper>
          <Autocomplete
            ...
            sx={{ width: '100%' }}
            value={props.divisionFormStore.getCommander()}
          />
        </ColumnWrapper>
      </RowWrapper>
    </>
